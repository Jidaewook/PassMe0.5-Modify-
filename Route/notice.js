...
router.post('/', upload.upload.single('thumbnail'), authCheck, notice_post);

router.get('/', notice_get);

router.get('/:noticeModelId', notice_detailget);

router.patch('/:noticeModelId', authCheck, notice_patch);

router.delete('/:noticeModelId', authCheck, notice_del);
